...
public class CloudSimTags {
	...
	public static final int JOB_RECEIVED = BASE + 49;
	
	//public static final int MAPTASK_FINISHED = BASE + 50;

	public static final int REDUCETASK_FINISHED = BASE + 51;

	public static final int MAPPER_STARTING = BASE +52;

	public static final int REDUCER_STARTING = BASE +53;

	public static final int EXECUTE_MAPPER = BASE +54;

	public static final int JOBREQUEST = BASE + 55;

	public static final int EACH_JOB_MAPTASK_EXECUTION_SUCCESS = BASE + 56;

	public static final int EXECUTE_REDUCETASK = BASE + 57;

	public static final int MAP_TO_BROKER = BASE + 58;

	public static final int SINGLE_MAPTASK_EXECUTION_SUCCESS_From_BROKER_To_MAPPER = BASE + 59;

	public static final int SINGLE_MAPTASK_EXECUTION_SUCCESS_From_MAPPER_TASKTRACKER = BASE + 60;

	public static final int REDUCE_TO_BROKER = BASE + 61;

	public static final int SINGLE_REDUCETASK_EXECUTION_SUCCESS_From_BROKER_REDUCER = BASE + 62;

	public static final int SINGLE_REDUCETASK_EXECUTION_SUCCESS_From_REDUCER_TASKTRACKER = BASE + 63;

	public static final int ALL_MAPTASK_EXECUTION_SUCCESS = BASE + 64;

	public static final int START_EXECUTE_REDUCETASK = BASE + 65;

	public static final int CLOUDLET_SUBMIT_IoTSim = BASE + 66;

	public static final int CLOUDLET_SUBMIT_IoTSim_ACK = BASE + 67;
	
	public static final int TRANSMISSION_FINISHED = BASE + 68;

	public static final int PASS_IOT_DATA = 69;

	public static final int START_COPY_DATA_FROM_STORAGE = 70;

	public static final int PASS_CLOUDLET = 71;
