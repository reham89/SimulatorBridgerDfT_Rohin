...
public class SimEvent implements Cloneable, Comparable<SimEvent>, Serializable{
	...
	public String toString() {
		System.out.println("Event tag = " + tag + " source = " + MainEventManager.getEntity(entSrc).getName() + " destination = "
				+ MainEventManager.getEntity(entDst).getName());
		return "Event tag = " + tag + " source = " + MainEventManager.getEntity(entSrc).getName() + " destination = "
				+ MainEventManager.getEntity(entDst).getName();
	}
